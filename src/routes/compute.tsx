...
const ACCELERATORS = [
  ...
  },
  {
    ...
    status: (
      <>
        Shipping (200K-250K units target)
...
const METRICS = [
  {
    label: "TSMC 2nm Node Wafer Price",
    value: "$30,000",
    desc: (
      <>
        A 50% increase over N3's ~$20,000 wafer cost, driven by GAA complexity.
        <Citation id="tsmc-2nm-production" />
      </>
    ),
  },
  {
    label: "Rubin Memory Bandwidth",
    value: "22 TB/s",
    desc: (
      <>
  ...
  {
    label: "CoWoS CAGR (2022-2027)",
    value: ">80%",
    desc: (
      <>
        TSMC's projected annual growth rate for chip-on-wafer-on-substrate packaging.
        <Citation id="beyond-blackwell" />
      </>
    ),
  },
  {
    label: "TSMC SoIC Capacity CAGR",
    value: ">90%",
    desc: (
      <>
  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-7xl px-6 lg:px-10 pt-20 pb-16">
        ...
        <h1 className="display mt-6 text-[clamp(2.5rem,7vw,7rem)] max-w-6xl leading-[0.95] text-wrap-balance">
        ...
        <p className="mt-8 max-w-3xl text-xl text-foreground/75 leading-relaxed">
          The modern artificial intelligence ecosystem is fundamentally anchored to the physical
          limits of semiconductor fabrication. As transistor scaling approaches atomic boundaries,
          progress is defined by packaging architectures, memory bandwidth, and numeric precision.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 lg:px-10 py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-border border border-border rounded-3xl overflow-hidden">
          {METRICS.map((m) => (
            <div
              key={m.label}
              className="bg-background p-8 flex flex-col justify-between min-h-[200px]"
            >
              <div>
      ...
      <section className="mx-auto max-w-7xl px-6 lg:px-10 py-16 grid lg:grid-cols-12 gap-12 lg:gap-16">
        <div className="lg:col-span-8 space-y-12">
          ...
          <div>
            <h2
              id="transistor-scaling"
              className="font-display text-3xl lg:text-4xl border-b border-border pb-4 mb-6"
            >
              Transistor Scaling & GAA Nanosheets
            </h2>
            <div className="space-y-4 text-foreground/85 leading-relaxed">
              <p>
                Taiwan Semiconductor Manufacturing Company (TSMC) officially launched mass volume
                production of its **2nm (N2) node in Q4 2025**
                <Citation id="tsmc-2nm-production" />, marking the industry's transition from
                traditional FinFET architectures to **Gate-All-Around (GAA) nanosheet** transistors.
              </p>
              <p>
                The N2 node delivers **10–15% performance gains at iso-power**, or **25–30% power
                reduction at iso-performance**, alongside a **15% density uplift** for mixed designs
                (up to 20% for logic-only components) compared to N3E. This technological leap has
                come with massive capital requirements: advanced N2 wafer prices have risen to
                approximately **$30,000 per wafer**
                <Citation id="tsmc-2nm-production" />, compared to ~$20,000 for 3nm.
              </p>
              <p>
                Volume production is currently centered at **Fab 22 in Kaohsiung** and **Fab 20 in
                Hsinchu**, with TSMC planning a **70% compound annual growth rate in 2nm capacity
                from 2026 to 2028**
                <Citation id="tsmc-2nm-growth" />. In contrast, Intel's rival **18A process** has
                entered volume manufacturing primarily for internal use, struggling to capture
                high-volume external foundry clients, leaving TSMC as the uncontested fabricator of
                the AI frontier.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-foreground/85 leading-relaxed">
              <p>
                As monolithic dies hit the physical reticle limit, performance scaling has shifted
                to multi-die architectures. TSMC's **CoWoS (Chip-on-Wafer-on-Substrate)**
                wafer-level packaging is the primary physical bottleneck of the AI accelerator
                supply chain. By stacking logic processors and High Bandwidth Memory (HBM) on a
                silicon interposer, CoWoS enables high-bandwidth, low-latency inter-die connections.
              </p>
              <p>
                TSMC projects **CoWoS capacity to grow more than 80% annually from 2022 to 2027**
                <Citation id="beyond-blackwell" />, while its **SoIC (System-on-Integrated-Chips)**
                3D-stacking capacity is projected to increase **over 90% per year**
                <Citation id="beyond-blackwell" />. Advanced packaging remains the single biggest
                chokepoint limiting AI accelerator shipments globally.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-foreground/85 leading-relaxed">
              <p>
                The physics of training and inference represent a perpetual battle between
                computation and data movement:
              </p>
              <ul className="list-disc pl-5 space-y-3 mt-2">
                <li>
                  <strong>SRAM (Static RAM):</strong> Fast, on-die caches with sub-nanosecond
                  latency. While crucial for storing parameter states during active instruction
                  execution, SRAM is extremely expensive and occupies massive silicon area,
                  prompting architectures like Groq to rely on scale-up inter-chip SRAM networks.
                </li>
                <li>
                  <strong>HBM (High Bandwidth Memory):</strong> 3D-stacked DRAM connected via a
                  silicon interposer. The transition from Blackwell's HBM3e (8.0 TB/s) to the
                  next-generation **HBM4** starting in late 2026 will deliver up to **22 TB/s
                  bandwidth** and **288GB capacity** per GPU (implemented on the NVIDIA Rubin R100)
                  <Citation id="rubin-specs" />, bypassing the standard Key-Value (KV) cache memory
                  bottlenecks.
                </li>
                <li>
                  <strong>Numeric Precision:</strong> While training continues to utilize 16-bit
                  precisions (FP16/BF16), inference has shifted aggressively to lower bit-widths.
                  The introduction of **FP8** and **FP4** (specifically NVIDIA's NVFP4 with
                  micro-block scaling) allows up to **7× GEMM (General Matrix Multiply) speedups**
                  over Hopper, compressing large models without sacrificing semantic accuracy.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="lg:col-span-4 space-y-8 lg:sticky lg:top-24 h-fit">
          <div className="bg-cream/50 dark:bg-zinc-900/50 border border-border p-6 rounded-3xl">
            ...
            <ul className="space-y-2 text-xs font-mono">
              <li>
                <a
                  href="#transistor-scaling"
                  className="text-foreground/75 hover:text-ember transition-colors block"
                >
              ...
              <li>
                <a
                  href="#packaging-bottleneck"
                  className="text-foreground/75 hover:text-ember transition-colors block"
                >
                  2. Packaging Bottlenecks
                </a>
              </li>
              <li>
                <a
                  href="#memory-precision"
                  className="text-foreground/75 hover:text-ember transition-colors block"
                >
                  3. Memory & Precision
                </a>
          ...
          <div className="bg-cream dark:bg-zinc-900 border border-border p-6 rounded-3xl">
            ...
            <ul className="space-y-4 text-xs font-mono">
              <li>
                <a
                  href="https://focustaiwan.tw/sci-tech/202604280010"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-ember hover:underline block mb-1"
                >
              ...
              <li>
                <a
                  href="https://www.tsmc.com/english/news/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-ember hover:underline block mb-1"
                >
                  [2] TSMC N2 GAA Volume Production
                </a>
                Volume production launch metrics, transistor density, and power curves.
              </li>
              <li>
                <a
                  href="https://tech-insider.org/nvidia-gtc-2026-rubin-gpu-analysis/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-ember hover:underline block mb-1"
                >
          ...
          <div className="rounded-3xl border border-border p-6">
            ...
            <p className="text-sm text-foreground/70 mb-4">
              How do these physical chips convert electricity and logic gates into language? Inspect
      ...
      {/* Hardware Table */}
      <section id="specs-table" className="mx-auto max-w-7xl px-6 lg:px-10 py-12">
              ...
              <tbody className="divide-y divide-border/60">
                {ACCELERATORS.map((a) => (
                  <tr key={a.name} className="hover:bg-cream/20 dark:hover:bg-zinc-900/20">
                    <td className="p-4 lg:p-6 font-display font-medium text-base text-ember">
                      {a.name}
                    </td>
