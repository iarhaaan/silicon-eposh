...
const STEPS = [
  ...
  },
  {
    ...
    b: "Predict the next token across 20+ trillion tokens of books, code, and synthetic datasets. Trillions of weights absorb a compressed mathematical model of human knowledge. A frontier training run today scales beyond 10^26 FLOPs and costs $100M to $1B+ in compute.",
  },
  {
    n: "05",
    t: "Post-training Alignment",
    b: "Refining raw models into helpful assistants via a three-stage pipeline: Supervised Fine-Tuning (SFT), Preference Alignment (DPO has largely replaced PPO, reducing GPU usage by ~50%), and Reinforcement Learning with Verifiable Rewards (like GRPO or RLVR) for coding and math.",
  },
  {
    n: "06",
    t: "Reasoning & thinking",
    b: "Reasoning models (OpenAI o1/o3, DeepSeek-R1, Qwen-QwQ) scale test-time compute. By emitting 20,000–60,000 internal 'thinking' tokens, models perform multi-step search, self-correction, and logical verification before displaying their final answer.",
  },
  {
    n: "07",
  ...
  },
  {
    n: "08",
    t: "Agentic Execution",
    b: "The model runs in loops, writing code, executing in sandboxes, calling APIs, and reading documents. Rather than single-turn answers, frameworks like Claude Code and Devin behave as autonomous teammates, combining planning and execution.",
  },
];
